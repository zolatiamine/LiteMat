...
import org.apache.jena.vocabulary.{RDF, OWL2}
...
object MainTbox {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val Tbox: TBoxServices = new TBoxServices(FilePath.OwlFiLE, "dictionaryTbox")
    Tbox.loadModel()
    ...
    Tbox.getDictionary().addProperty(RDF.`type`.getURI,0,0,1)
